...
FROM (
         SELECT pa.P_Asset_acct                                                          AS C_ValidCombination_ID,
                ...
                COALESCE(
                        getCurrentCost(hus.M_Product_ID, p_keydate::date, schema.c_acctschema_id, schema.costingmethod,
         ...
         GROUP BY pa.P_Asset_acct,
                  ...
                  hus.M_Product_ID,
                  hus.C_UOM_ID,
                  COALESCE(getCurrentCost(hus.M_Product_ID, p_keydate::date, schema.c_acctschema_id,
                                          schema.costingmethod,
         ...
         SELECT pa.P_Asset_acct                                                   AS C_ValidCombination_ID,
                ...
                COALESCE(getCurrentCost(p.M_Product_ID, p_keydate::date, schema.c_acctschema_id, schema.costingmethod,
